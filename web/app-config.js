...
(function initConfig(){
  ...
  const DEFAULTS = {
    version: "v0.1.0",
    gasUrl: "https://script.google.com/macros/s/AKfycbyPI4gxzoTioiRIRAaLjxohEYkHZOPyGgyIwjvm5Fdrg6rINmktsBUnzeBdVLcRtoGd/exec",                // ضع هنا URL بعد نشر GAS كـ Web App (شرح في docs/SETUP.md)
    locale: "ar",              // ar | en | fr
    rtl: true,
